...
function settings(){
  ...
  function showMenu(){
    ...
    foot.append(el('div', {class:'meta'}, 'TimeMate by J.W. Version 1.22'));
    content.append(foot);
  }
  ...
  function gridForm(){
    return el('div', {style:'display:grid;grid-template-columns:260px 1fr;gap:10px;align-items:center'});
  }
  ...
  function showSection(id){
    ...
    if(id==='view'){
      ...
      g1.append(el('label',{},'Heute-Karte anzeigen')); g1.append(selShow);
      ...
      g1.append(el('label',{},'Detailgrad')); g1.append(selMode);
      ...
      g1.append(el('label',{},'Aufgaben des Tages anzeigen')); g1.append(selTasks);
      cardToday.append(g1);
      ...
      g2.append(el('label',{},'„Morgen/Übermorgen“ abtrennen')); g2.append(selNext2);
      ...
      g2.append(el('label',{},'„Ansicht wechseln“-Button')); g2.append(selToggle);
