(function () {
  ...
  function init() {
    ...
    // ====== Zähler für Bestätigungen (pro Person) ======
...
<body>
  ...
  <script>
    setTimeout(function(){ window.print(); }, 250);
        ...
        // Download der HTML-Datei mit dem Namen (PDF-Dateiname kann vom Browser nicht direkt gesetzt werden)
        try{
        ...
        // Print-Preview in neuem Tab; Dokumenttitel = gewünschter Dateiname
