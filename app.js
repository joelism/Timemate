...
<body>
  ...
  <script>setTimeout(function(){ window.print(); }, 250);</script>
    ...
    function form(editId){
      ...
      // === Auto-Standort: priorisiere Personen-Adresse, sonst Kategorie-Hauptadresse ===
      ...
      function applyAutoLocation(){
        try{
          ...
          // 1) Personen-Adresse aus Kontakten
          ...
          // 2) Fallback: Hauptadresse der Kategorie
          ...
          if(addr2){
            if(locEl.tagName==='INPUT'){
              ...
              const exists2 = Array.from(locEl.options).some(o => (o.value||o.textContent) === addr2);
              if(!exists2){
                const op2=document.createElement('option'); op2.value=addr2; op2.textContent=addr2;
                locEl.insertBefore(op2, locEl.firstChild);
              }
              if(empty) locEl.value = addr2;
            }
          }
