...
(function(){
  ...
  // Error overlay (helps if something breaks)
  (function(){
  ...
  // Load state; be lenient with legacy keys
  const v = byId('view');
  const loadItems = () => {
    const keys = ['tmjw_state','TimeMateJW_state','tmjw_items','items'];
    for(const k of keys){
      try{
